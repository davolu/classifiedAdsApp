...
?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h4 class="page-header">New Item</h4>
    ...
    <img src=" " id="pre1"   class="img-responsive "  title="" style="cursor:pointer; width:200px; height:100px;"/>
	 ...
	 <input type="text"  id="bs1" style="display:none;"  />
    ...
    <img src=" " id="pre2"   class="img-responsive "  title="" style="cursor:pointer; width:200px; height:100px;"/>
     </div>
	 ...
	 <input type="text"  id="bs2" style="display:none;"  />
    ...
    <img src=" " id="pre3"   class="img-responsive "  title="" style="cursor:pointer; width:200px; height:100px;"/>
     </div>
	 ...
	 <input type="text"  id="bs3" style="display:none;"  />
	...
	<input type="text" class="input-lg form-control"  id="item_name" />
	<br/>
	<br/>
			</div>
	...
	<input type="number" class="input-lg form-control"  id="item_price" />
	<br/>
	<br/>
			</div>
	...
	<select class="input-lg form-control"  id="item_sub_category" disabled="disabled">
  ...
  <textarea  class="input-lg form-control"  id="item_details" rows="10" cols="50"> </textarea>
  <br/>
  <br/>
				</div>
